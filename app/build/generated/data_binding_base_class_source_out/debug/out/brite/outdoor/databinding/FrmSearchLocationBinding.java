...
public abstract class FrmSearchLocationBinding extends ViewDataBinding {
  @NonNull
  ...
  protected FrmSearchLocationBinding(Object _bindingComponent, View _root, int _localFieldCount,
  ...
  @NonNull
  public static FrmSearchLocationBinding inflate(@NonNull LayoutInflater inflater,
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.frm_search_location, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static FrmSearchLocationBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<FrmSearchLocationBinding>inflateInternal(inflater, R.layout.frm_search_location, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.frm_search_location, null, false, component)
   */
  @NonNull
  @Deprecated
  public static FrmSearchLocationBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<FrmSearchLocationBinding>inflateInternal(inflater, R.layout.frm_search_location, null, false, component);
  }

  public static FrmSearchLocationBinding bind(@NonNull View view) {
   ...
   */
  @Deprecated
  public static FrmSearchLocationBinding bind(@NonNull View view, @Nullable Object component) {
    return (FrmSearchLocationBinding)bind(component, view, R.layout.frm_search_location);
  }
}
