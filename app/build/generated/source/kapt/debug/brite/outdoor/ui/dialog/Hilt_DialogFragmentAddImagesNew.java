...
public abstract class Hilt_DialogFragmentAddImagesNew extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DialogFragmentAddImagesNew() {
    super();
  }

  Hilt_DialogFragmentAddImagesNew(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DialogFragmentAddImagesNew_GeneratedInjector) this.generatedComponent()).injectDialogFragmentAddImagesNew(UnsafeCasts.<DialogFragmentAddImagesNew>unsafeCast(this));
    }
  }
