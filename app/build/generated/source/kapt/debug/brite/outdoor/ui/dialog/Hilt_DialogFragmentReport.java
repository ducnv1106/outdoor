...
public abstract class Hilt_DialogFragmentReport extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DialogFragmentReport() {
    super();
  }

  Hilt_DialogFragmentReport(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DialogFragmentReport_GeneratedInjector) this.generatedComponent()).injectDialogFragmentReport(UnsafeCasts.<DialogFragmentReport>unsafeCast(this));
    }
  }
