...
public abstract class Hilt_PreviewFragment<B extends ViewBinding> extends BaseFragmentMedia<B> implements GeneratedComponentManagerHolder {
  ...
  Hilt_PreviewFragment(int fragmentLayout) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PreviewFragment_GeneratedInjector) this.generatedComponent()).injectPreviewFragment(UnsafeCasts.<PreviewFragment>unsafeCast(this));
    }
  }
