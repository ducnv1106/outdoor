...
public abstract class Hilt_FrmPersonalPage<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmPersonalPage_GeneratedInjector) this.generatedComponent()).injectFrmPersonalPage(UnsafeCasts.<FrmPersonalPage>unsafeCast(this));
    }
  }
