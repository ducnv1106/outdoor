...
public abstract class Hilt_FrmDetail<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmDetail_GeneratedInjector) this.generatedComponent()).injectFrmDetail(UnsafeCasts.<FrmDetail>unsafeCast(this));
    }
  }
