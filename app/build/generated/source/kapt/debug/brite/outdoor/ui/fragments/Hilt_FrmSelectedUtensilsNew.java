...
public abstract class Hilt_FrmSelectedUtensilsNew<T> extends BaseDialogFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmSelectedUtensilsNew_GeneratedInjector) this.generatedComponent()).injectFrmSelectedUtensilsNew(UnsafeCasts.<FrmSelectedUtensilsNew>unsafeCast(this));
    }
  }
