...
public abstract class Hilt_FrmFocus<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmFocus_GeneratedInjector) this.generatedComponent()).injectFrmFocus(UnsafeCasts.<FrmFocus>unsafeCast(this));
    }
  }
