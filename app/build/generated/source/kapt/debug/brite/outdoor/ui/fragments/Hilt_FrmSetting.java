...
public abstract class Hilt_FrmSetting<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmSetting_GeneratedInjector) this.generatedComponent()).injectFrmSetting(UnsafeCasts.<FrmSetting>unsafeCast(this));
    }
  }
