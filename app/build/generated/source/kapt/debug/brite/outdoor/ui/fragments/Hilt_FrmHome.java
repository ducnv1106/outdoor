...
public abstract class Hilt_FrmHome<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmHome_GeneratedInjector) this.generatedComponent()).injectFrmHome(UnsafeCasts.<FrmHome>unsafeCast(this));
    }
  }
