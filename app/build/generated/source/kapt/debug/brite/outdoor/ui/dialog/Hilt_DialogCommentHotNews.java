...
public abstract class Hilt_DialogCommentHotNews extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DialogCommentHotNews_GeneratedInjector) this.generatedComponent()).injectDialogCommentHotNews(UnsafeCasts.<DialogCommentHotNews>unsafeCast(this));
    }
  }
