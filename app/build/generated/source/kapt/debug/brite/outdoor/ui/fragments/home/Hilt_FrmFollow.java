...
public abstract class Hilt_FrmFollow<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmFollow_GeneratedInjector) this.generatedComponent()).injectFrmFollow(UnsafeCasts.<FrmFollow>unsafeCast(this));
    }
  }
