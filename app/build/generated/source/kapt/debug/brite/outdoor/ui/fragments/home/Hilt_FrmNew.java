...
public abstract class Hilt_FrmNew<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmNew_GeneratedInjector) this.generatedComponent()).injectFrmNew(UnsafeCasts.<FrmNew>unsafeCast(this));
    }
  }
