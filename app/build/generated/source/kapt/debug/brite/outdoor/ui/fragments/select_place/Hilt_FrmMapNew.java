...
public abstract class Hilt_FrmMapNew<T> extends BaseDialogFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmMapNew_GeneratedInjector) this.generatedComponent()).injectFrmMapNew(UnsafeCasts.<FrmMapNew>unsafeCast(this));
    }
  }
