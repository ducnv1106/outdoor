...
public abstract class Hilt_FrmCommentQuestion<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmCommentQuestion_GeneratedInjector) this.generatedComponent()).injectFrmCommentQuestion(UnsafeCasts.<FrmCommentQuestion>unsafeCast(this));
    }
  }
