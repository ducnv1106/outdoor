...
public abstract class Hilt_FrmSearchVer2<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmSearchVer2_GeneratedInjector) this.generatedComponent()).injectFrmSearchVer2(UnsafeCasts.<FrmSearchVer2>unsafeCast(this));
    }
  }
