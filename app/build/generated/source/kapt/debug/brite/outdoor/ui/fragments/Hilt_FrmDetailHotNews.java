...
public abstract class Hilt_FrmDetailHotNews<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmDetailHotNews_GeneratedInjector) this.generatedComponent()).injectFrmDetailHotNews(UnsafeCasts.<FrmDetailHotNews>unsafeCast(this));
    }
  }
