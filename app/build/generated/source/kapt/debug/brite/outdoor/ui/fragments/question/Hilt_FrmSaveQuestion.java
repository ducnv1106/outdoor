...
public abstract class Hilt_FrmSaveQuestion<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmSaveQuestion_GeneratedInjector) this.generatedComponent()).injectFrmSaveQuestion(UnsafeCasts.<FrmSaveQuestion>unsafeCast(this));
    }
  }
