...
public abstract class Hilt_FrmFrequentQuestion<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmFrequentQuestion_GeneratedInjector) this.generatedComponent()).injectFrmFrequentQuestion(UnsafeCasts.<FrmFrequentQuestion>unsafeCast(this));
    }
  }
