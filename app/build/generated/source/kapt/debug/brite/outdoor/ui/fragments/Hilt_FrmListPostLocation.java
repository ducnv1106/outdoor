...
public abstract class Hilt_FrmListPostLocation<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmListPostLocation_GeneratedInjector) this.generatedComponent()).injectFrmListPostLocation(UnsafeCasts.<FrmListPostLocation>unsafeCast(this));
    }
  }
