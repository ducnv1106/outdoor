...
public abstract class Hilt_FrmNotification<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmNotification_GeneratedInjector) this.generatedComponent()).injectFrmNotification(UnsafeCasts.<FrmNotification>unsafeCast(this));
    }
  }
