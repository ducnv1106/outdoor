...
public abstract class Hilt_FrmMap<T> extends BaseDialogFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmMap_GeneratedInjector) this.generatedComponent()).injectFrmMap(UnsafeCasts.<FrmMap>unsafeCast(this));
    }
  }
