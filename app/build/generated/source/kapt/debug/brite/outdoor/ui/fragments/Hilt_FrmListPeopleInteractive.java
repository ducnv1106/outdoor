...
public abstract class Hilt_FrmListPeopleInteractive<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmListPeopleInteractive_GeneratedInjector) this.generatedComponent()).injectFrmListPeopleInteractive(UnsafeCasts.<FrmListPeopleInteractive>unsafeCast(this));
    }
  }
