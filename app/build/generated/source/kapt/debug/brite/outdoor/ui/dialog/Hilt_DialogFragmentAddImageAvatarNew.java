...
public abstract class Hilt_DialogFragmentAddImageAvatarNew<T> extends BaseDialogFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DialogFragmentAddImageAvatarNew_GeneratedInjector) this.generatedComponent()).injectDialogFragmentAddImageAvatarNew(UnsafeCasts.<DialogFragmentAddImageAvatarNew>unsafeCast(this));
    }
  }
