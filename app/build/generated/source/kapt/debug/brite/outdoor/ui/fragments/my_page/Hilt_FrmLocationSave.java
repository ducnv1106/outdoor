...
public abstract class Hilt_FrmLocationSave<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmLocationSave_GeneratedInjector) this.generatedComponent()).injectFrmLocationSave(UnsafeCasts.<FrmLocationSave>unsafeCast(this));
    }
  }
