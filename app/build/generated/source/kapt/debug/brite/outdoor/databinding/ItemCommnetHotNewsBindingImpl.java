...
public class ItemCommnetHotNewsBindingImpl extends ItemCommnetHotNewsBinding  {
    ...
    public ItemCommnetHotNewsBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 18, sIncludes, sViewsWithIds));
    }
    private ItemCommnetHotNewsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((brite.outdoor.data.api_entities.response.ResponseListCommentHotNews.CommentHotNews) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable brite.outdoor.data.api_entities.response.ResponseListCommentHotNews.CommentHotNews Item) {
        this.mItem = Item;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        brite.outdoor.data.api_entities.response.ResponseListCommentHotNews.CommentHotNews item = mItem;
