...
public abstract class Hilt_DialogComment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DialogComment_GeneratedInjector) this.generatedComponent()).injectDialogComment(UnsafeCasts.<DialogComment>unsafeCast(this));
    }
  }
