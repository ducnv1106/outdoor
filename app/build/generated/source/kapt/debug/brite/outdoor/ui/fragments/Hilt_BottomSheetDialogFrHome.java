...
public abstract class Hilt_BottomSheetDialogFrHome extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BottomSheetDialogFrHome_GeneratedInjector) this.generatedComponent()).injectBottomSheetDialogFrHome(UnsafeCasts.<BottomSheetDialogFrHome>unsafeCast(this));
    }
  }
