...
public abstract class Hilt_FrmMyBookMart<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmMyBookMart_GeneratedInjector) this.generatedComponent()).injectFrmMyBookMart(UnsafeCasts.<FrmMyBookMart>unsafeCast(this));
    }
  }
