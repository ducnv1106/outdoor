...
public abstract class Hilt_FrmHotNews<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmHotNews_GeneratedInjector) this.generatedComponent()).injectFrmHotNews(UnsafeCasts.<FrmHotNews>unsafeCast(this));
    }
  }
