...
public abstract class Hilt_FrmSearchLocation<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmSearchLocation_GeneratedInjector) this.generatedComponent()).injectFrmSearchLocation(UnsafeCasts.<FrmSearchLocation>unsafeCast(this));
    }
  }
