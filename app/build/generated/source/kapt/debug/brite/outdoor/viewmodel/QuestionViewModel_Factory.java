...
public final class QuestionViewModel_Factory implements Factory<QuestionViewModel> {
  ...
  public QuestionViewModel_Factory(Provider<Gson> gsonProvider,
  ...
  public static QuestionViewModel_Factory create(Provider<Gson> gsonProvider,
      Provider<ApiController> apiControllerProvider) {
    return new QuestionViewModel_Factory(gsonProvider, apiControllerProvider);
  }

  public static QuestionViewModel newInstance(Gson gson, ApiController apiController) {
    return new QuestionViewModel(gson, apiController);
  }
}
