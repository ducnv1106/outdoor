...
public abstract class Hilt_DialogFragmentReminder<T> extends BaseDialogFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DialogFragmentReminder_GeneratedInjector) this.generatedComponent()).injectDialogFragmentReminder(UnsafeCasts.<DialogFragmentReminder>unsafeCast(this));
    }
  }
