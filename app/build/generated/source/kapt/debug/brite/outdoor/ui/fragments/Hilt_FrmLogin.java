...
public abstract class Hilt_FrmLogin<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmLogin_GeneratedInjector) this.generatedComponent()).injectFrmLogin(UnsafeCasts.<FrmLogin>unsafeCast(this));
    }
  }
