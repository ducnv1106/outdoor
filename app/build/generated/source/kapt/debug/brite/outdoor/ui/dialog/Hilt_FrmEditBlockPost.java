...
public abstract class Hilt_FrmEditBlockPost extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FrmEditBlockPost() {
    super();
  }

  Hilt_FrmEditBlockPost(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmEditBlockPost_GeneratedInjector) this.generatedComponent()).injectFrmEditBlockPost(UnsafeCasts.<FrmEditBlockPost>unsafeCast(this));
    }
  }
