...
public abstract class Hilt_FrmEditQuestion<T> extends BaseDialogFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmEditQuestion_GeneratedInjector) this.generatedComponent()).injectFrmEditQuestion(UnsafeCasts.<FrmEditQuestion>unsafeCast(this));
    }
  }
