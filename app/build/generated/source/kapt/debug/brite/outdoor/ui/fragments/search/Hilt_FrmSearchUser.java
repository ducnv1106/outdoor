...
public abstract class Hilt_FrmSearchUser<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmSearchUser_GeneratedInjector) this.generatedComponent()).injectFrmSearchUser(UnsafeCasts.<FrmSearchUser>unsafeCast(this));
    }
  }
