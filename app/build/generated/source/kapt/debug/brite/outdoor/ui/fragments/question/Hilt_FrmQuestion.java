...
public abstract class Hilt_FrmQuestion<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmQuestion_GeneratedInjector) this.generatedComponent()).injectFrmQuestion(UnsafeCasts.<FrmQuestion>unsafeCast(this));
    }
  }
