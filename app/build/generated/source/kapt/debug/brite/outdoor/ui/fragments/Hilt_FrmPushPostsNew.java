...
public abstract class Hilt_FrmPushPostsNew<T> extends BaseDialogFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmPushPostsNew_GeneratedInjector) this.generatedComponent()).injectFrmPushPostsNew(UnsafeCasts.<FrmPushPostsNew>unsafeCast(this));
    }
  }
