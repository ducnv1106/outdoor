...
public abstract class Hilt_FrmSearchUtensils<T> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrmSearchUtensils_GeneratedInjector) this.generatedComponent()).injectFrmSearchUtensils(UnsafeCasts.<FrmSearchUtensils>unsafeCast(this));
    }
  }
