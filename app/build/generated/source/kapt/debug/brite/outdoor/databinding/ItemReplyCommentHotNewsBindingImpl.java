...
public class ItemReplyCommentHotNewsBindingImpl extends ItemReplyCommentHotNewsBinding  {
    ...
    public ItemReplyCommentHotNewsBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }
    private ItemReplyCommentHotNewsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((brite.outdoor.data.api_entities.response.ResponseListCommentHotNews.CommentHotNewsReply) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable brite.outdoor.data.api_entities.response.ResponseListCommentHotNews.CommentHotNewsReply Item) {
        this.mItem = Item;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        brite.outdoor.data.api_entities.response.ResponseListCommentHotNews.CommentHotNewsReply item = mItem;
