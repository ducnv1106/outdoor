...
public class ItemReportBindingImpl extends ItemReportBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.viewLine2, 2);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((brite.outdoor.data.api_entities.response.ResponseReport.Report) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable brite.outdoor.data.api_entities.response.ResponseReport.Report Item) {
        this.mItem = Item;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        brite.outdoor.data.api_entities.response.ResponseReport.Report item = mItem;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tvContent1, itemContent);
        }
    }
