...
class ApiConst {
    companion object {
        ...
        val API_KEY =if (AppConst.TEST_MODE) "12ca361d-3ac8-9f90d-5d60-a625addabd05e" else "18622762-27ee-4761-b37f-eb822dc3499c"
        ...
        val DOMAIN_NAME = if(AppConst.TEST_MODE) "https://outdoor.brite.vn/api/" else "https://outdoorvn.com/api/"
        ...
        const val API_LIST_QUESTION="v$API_VERSION/Question/listQuestion"
        const val API_CREATE_QUESTION="v$API_VERSION/Question/create"
        const val API_QUESTION_LIKE = "v$API_VERSION/Question/like"
        const val API_BOOKMARK_QUESTION = "v$API_VERSION/Question/bookmark"
        const val API_DELETE_QUESTION ="v$API_VERSION/Question/delete/"
        const val API_LIST_ANSWER_QUESTION = "v$API_VERSION/Question/listAnser/"
        const val API_ANSWER_QUESTION = "v$API_VERSION/Question/answer"
        const val API_EDIT_QUESTION = "v$API_VERSION/Question/edit/"
        const val API_DELETE_ANSWER_QUESTION = "v$API_VERSION/Question/deleteAnswer/"
        const val API_LIST_REPLY_ANSWER_QUESTION = "v$API_VERSION/Question/listAnserLvl2/"
        const val API_DETAIL_QUESTION = "v$API_VERSION/Question/detail/"
        const val API_LIST_CAMPING = "v$API_VERSION/Camping/listCamping"
        const val API_CREATE_CAMPING = "v$API_VERSION/Camping/create"
        const val API_DELETE_CAMPING = "v$API_VERSION/Camping/delete/"
        const val API_LIST_CADASTRALS= "v$API_VERSION/user/listCadastrals"
        const val API_LIST_POST_HOT_NEWS = "v$API_VERSION/Hotnews/listHotNews"
        const val API_DETAIL_POST_HOT_NEWS = "v$API_VERSION/Hotnews/detail/"
        const val API_POST_HOT_NEWS_LIKE = "v$API_VERSION/Hotnews/like"
        const val API_POST_HOT_NEWS_SHARES = "v$API_VERSION/Hotnews/share"
        const val API_LIST_COMMENT_HOT_NEWS = "v$API_VERSION/Hotnews/listComment/"
        const val API_DELETE_COMMENT_HOT_NEWS = "v$API_VERSION/Hotnews/deleteComment"
        const val API_POST_COMMENT_HOT_NEWS = "v$API_VERSION/Hotnews/comment"
        const val API_LIST_REPLY_COMMENT_HOT_NEWS = "v$API_VERSION/Hotnews/listCommentLvl2/"
        ...
        const val PARAM_API_LOCATION_ADDRESS = "location_address"
        ...
        const val PARAM_CONTENT_KEY_DEL="content_key_del"
        ...
        const val PARAM_API_HOT_NEWS_ID ="hot_news_id"
        //bookmark
